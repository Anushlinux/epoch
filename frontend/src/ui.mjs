...
export function shell({
  ...
  const footerMessage = demo ? "No tools or tests execute" : page === "traces" ? "Trace explorer · changes on request" : page === "chat" ? "Hermes chat · simulated tools" : "Debugger · runs on request";
